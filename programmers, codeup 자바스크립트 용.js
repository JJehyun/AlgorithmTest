...
//배열slice(잘라내기 시작할 index, 잘라내길 끝낼 index) 슬라이스
...
//sqrt제곱근 판별
//
//배열.indexof("요소")    ----->    몇번째 배열 요소인지 알려줌
//sort((a,b)=>b-a)       ----->     내림차순

// 정규식 관련
// var regex = /^\d{5}$|^\d{4}$/;     ---->d숫자로 시작^하는 5{5}글자, d숫자로 시작^하는 4{4}글자 
// console.log(regex.test(s))         ---->true / false
//--------------------------------------------------------------------------------------------------------
